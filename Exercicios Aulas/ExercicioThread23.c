...
//valores diferentes
//intut tem x1 = 1 e x2 = 2
//output vai dar x = 1 e x = 2 pois as variaveis iniciais são diferentes
//no primeiro a variavel era igual, e por isso os valores foram iguais